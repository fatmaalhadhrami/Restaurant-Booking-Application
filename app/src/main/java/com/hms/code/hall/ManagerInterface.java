...
import com.hms.code.admin.LoginActivity;
import com.hms.code.hall.DB.Assignment;
import com.hms.code.hall.DB.BillStatus;
import com.hms.code.hall.DB.Order;
import com.hms.code.hall.DB.OrderDetails;
import com.hms.code.hall.DB.Table;
import com.hms.code.hall.DB.Tablet;
import com.hms.code.hall.DB.Receipt;
import com.hms.code.hall.DB.Employee;
import com.hms.code.hall.DB.Item;
import com.hms.code.hall.DB.MenuItem;
import com.hms.code.hall.DB.Menu;

import com.hms.R;

import com.hms.code.reporting.EndOfDay_EventHandler;
...
public class ManagerInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View V) {
                Intent myIntent = new Intent(ManagerInterface.this,com.hms.code.billing.PendingPayments.class);
                startActivity(myIntent);
            }
        });
