                                        ...
                                        for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                                            ...
                                            if (employee != null) {
                                                if (employee.getType().equals("Hall Manager") && txtEmailLogin.getText().toString().equals(employee.getEmail())) {
                                                    ...
                                                    Intent i = new Intent(LoginActivity.this, com.hms.code.hall.ManagerInterface.class);
                                                    i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                                    startActivity(i);
                                                }
                                            }
                                            if (employee != null) {
                                                if (employee.getType().equals("Head Chef") && txtEmailLogin.getText().toString().equals(employee.getEmail())) {
                                                    ...
                                                    Intent i = new Intent(LoginActivity.this, com.hms.code.kitchen.MainActivity.class);
                                                    i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                                    startActivity(i);
                                                }
                                            }
