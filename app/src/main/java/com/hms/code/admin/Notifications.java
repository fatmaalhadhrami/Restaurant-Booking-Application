...
public class Notifications extends AppCompatActivity {
    ...
    ArrayList<com.hms.code.admin.NotificationClass> notifications;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifications = new ArrayList<com.hms.code.admin.NotificationClass>();
        ...
        if (isNetworkAvaliable(this)) {
            databaseReference.addValueEventListener(new ValueEventListener() {
                com.hms.code.admin.NotificationClass notification;
    ...
    public void onBackPressed() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                    notification = dsp.getValue(com.hms.code.admin.NotificationClass.class);
                    if (notification != null) {
                        databaseReference.child(dsp.getKey()).child("read").setValue(true);
                    }
                }
                notificationsAdapter = new com.hms.code.admin.NotificationsAdapter(getBaseContext(), notifications);
                rvNotifications.setAdapter(notificationsAdapter);
